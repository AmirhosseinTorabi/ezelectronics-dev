...
/* ADDED ERRORS */
const BIRTHDATE_INVALID = "Birthdate after current date"
const USER_IS_ADMIN_NOT_MODIFY = "Admins cannot be modified/deleted"
/**
...
class BirthdateIsAfterTodayError extends Error {
    customMessage: String;
    customCode: Number;

    constructor() {
        super()
        this.customMessage = BIRTHDATE_INVALID
        this.customCode = 400
    }
}

class UserIsAdminNotModifyError extends Error {
    customMessage: String;
    customCode: Number;

    constructor() {
        super()
        this.customMessage = USER_IS_ADMIN_NOT_MODIFY
        this.customCode = 401
    }
}

export { UserNotFoundError, UserNotManagerError, UserNotCustomerError, UserAlreadyExistsError, UserNotAdminError, UserIsAdminError, UnauthorizedUserError, BirthdateIsAfterTodayError, UserIsAdminNotModifyError }